    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-white p-6">
      ...
      >
        <div className="text-center mb-4">
          ...
          <p className="text-sm text-gray-500">Sign in to access your trips and bookings</p>
        </div>
        ...
        <p className="mt-4 text-center text-sm text-gray-600">No account? <Link className="text-blue-600 font-medium" to="/signup">Create one</Link></p>
      </motion.div>
    </div>
  );
}
